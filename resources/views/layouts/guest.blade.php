...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased bg-gray-100" style="background-color: #f3f4f6; color: #111827;">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 relative overflow-hidden">
            ...
            <div class="w-full sm:max-w-md mt-10 px-6 py-8 bg-white shadow-2xl overflow-hidden sm:rounded-2xl relative z-10 border-t-4 border-yellow-500">
                ...
                <div class="flex flex-col items-center mb-8">
                    ...
                    <p class="text-gray-500 text-sm font-medium mt-1">เทศบาลเมืองชัยภูมิ (นายก บรรยงค์)</p>
                </div>
